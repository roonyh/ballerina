import {
    Assignment, ASTUtil, Break, CompoundAssignment,
    ExpressionStatement, Function, Panic, VariableDef, ASTKindChecker
                ...
                {!viewState.hiddenBlock &&
                    <g className="statement">
                        ...
                        {!viewState.isAction && !viewState.hiddenBlock &&
                            ...
                            <ExpandedFunction model={viewState.expandedSubTree as Function}
